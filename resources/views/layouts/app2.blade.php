    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#agencies">Agencies</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#team">Account</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#contact">Contact</a>
                </li>
                <li class="dropdown nav-item">
                    <a class="nav-link js-scroll-trigger" href="#"  data-toggle="dropdown" role="button" aria-expanded="false">
                        {{ Auth::user()->name }} <span class="caret"></span>
                    </a>

                    <ul class="dropdown-menu nav-item" role="menu">
        ...
        <div class="row text-center">
            ...
            <span class="fa-stack fa-4x">
              <div class="timeline-image">
                            <img class="rounded-circle img-fluid" src="img/lto.png" alt="">
              </div>
            </span>
            ...
            <span class="fa-stack fa-4x">
               <div class="timeline-image">
                            <img class="rounded-circle img-fluid" src="img/NBISeal.jpg" style="height: 145px" alt="">
              </div>
            </span>
            ...
            <span class="fa-stack fa-4x">
              <div class="timeline-image">
                            <img class="rounded-circle img-fluid" src="img/dfa.png" style="height: 140px" alt="">
              </div>
            </span>
...
<section id="agencies">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading">Agencies</h2>
                <!--<h3 class="section-subheading text-muted">Lorem ipsum dolor sit amet consectetur.</h3>-->
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <ul class="timeline">
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>June 20, 1964</h4>
                                <h4 class="subheading">Land Transportation Office</h4>
                            </div>
                            <div class="timeline-body">
                                <p class="text-muted">
                                    The Land Transportation Office is an agency of the Philippine government under the Department of Transportation and is responsible for all land transportation in the Philippines, especially implementing transportation laws, rules and regulations.
                                    ...
                                    It created the Automobile Section under the Administrative Division of the Bureau of Public Works.
                    ...
                    <li class="timeline-inverted">
                        <div class="timeline-image">
                            <img class="rounded-circle img-fluid" src="img/NBISeal.jpg" alt="">
                        </div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>June 19, 1947</h4>
                                <h4 class="subheading">National Bureau of Investigation</h4>
                            </div>
                            <div class="timeline-body">
                                <p class="text-muted">
                    ...
                    <li>
                        <div class="timeline-image">
                            <img class="rounded-circle img-fluid" src="img/dfa.png"   style="height: 160px" alt="">
                        </div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>June 23, 1898</h4>
                                <h4 class="subheading">Department of Foreign Affairs</h4>
                            </div>
                            <div class="timeline-body">
                                <p class="text-muted">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h3 class="section-subheading text-muted">Team Project X</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                <div class="team-member">
                    <img class="mx-auto rounded-circle" src="img/portfolio/pao.jpg" alt="">
                    <h4>Paolo Ching</h4>
            ...
            <div class="col-sm-12">
                <div class="team-member">
                    <img class="mx-auto rounded-circle" src="img/portfolio/adres.jpg" alt="">
                    <h4>John Adres</h4>
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                <p class="large text-muted">This website serves as a final project and partial requirement in Web Development(WEBDEVT).</p>
            </div>
        </div>
    </div>
</section>
...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <span class="copyright">Copyright &copy; Government Integrated Agency 2017</span>
            </div>
            <div class="col-md-4">
                <ul class="list-inline social-buttons">
                    <li class="list-inline-item">
